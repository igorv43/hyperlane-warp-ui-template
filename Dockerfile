...
# Taxa administrativa + memo das transações (ver ADMINISTRATION_FEE_GUIDE.md)
ARG NEXT_PUBLIC_ADMIN_FEE_USD=
ARG NEXT_PUBLIC_ADMIN_FEE_WALLET_TERRACLASSIC=
ARG NEXT_PUBLIC_ADMIN_FEE_WALLET_BSC=
ARG NEXT_PUBLIC_ADMIN_FEE_WALLET_ETHEREUM=
ARG NEXT_PUBLIC_ADMIN_FEE_WALLET_SOLANA=
ARG NEXT_PUBLIC_TX_MEMO=
...
RUN : > .env.local && \
    for v in NEXT_PUBLIC_REGISTRY_URL NEXT_PUBLIC_REGISTRY_BRANCH NEXT_PUBLIC_GITHUB_PROXY \
             ...
             NEXT_PUBLIC_REFINER_TRANSFER_FORM_ID \
             NEXT_PUBLIC_ADMIN_FEE_USD NEXT_PUBLIC_ADMIN_FEE_WALLET_TERRACLASSIC \
             NEXT_PUBLIC_ADMIN_FEE_WALLET_BSC NEXT_PUBLIC_ADMIN_FEE_WALLET_ETHEREUM \
             NEXT_PUBLIC_ADMIN_FEE_WALLET_SOLANA NEXT_PUBLIC_TX_MEMO; do \
      eval "val=\$$v"; \
